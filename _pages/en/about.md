...
Hiraki’s research interests include **human–computer interaction**, particularly voice interfaces, silent speech recognition, and wearable sensing. This work combines sensing hardware and machine learning to make voice interaction practical in everyday environments. Projects include [ClothTalk]({{ '/project/clothtalk/' | relative_url }}), [SilentWhisper]({{ '/project/silentwhisper/' | relative_url }}), and [MaskClip]({{ '/project/maskclip/' | relative_url }}), which explore speech input through very quiet utterances and in noisy environments. Awards include James Dyson Award 2024 (Japan National Winner) and the IPSJ Yamashita Memorial Research Award (2026).
